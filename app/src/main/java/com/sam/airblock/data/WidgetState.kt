...
data class WidgetState(
    ...
    /** First tag from plane-alert-db for this airframe ("Military", "Royal"…). */
    val alertTag: String? = null,
    /** plane-alert-db category, e.g. "Military", "Government". */
    val alertCategory: String? = null,
