    ...
    suspend fun tick() {
        ...
        try {
            ...
            fun buildState(
                ...
                depDelayMin = prev.depDelayMin.takeIf { sameFlight },
                ...
                actualDepLocal = prev.actualDepLocal.takeIf { sameFlight },
                actualArrLocal = prev.actualArrLocal.takeIf { sameFlight },
